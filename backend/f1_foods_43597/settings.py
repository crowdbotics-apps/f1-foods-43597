"""
Django settings for f1_foods_43597 project.
...
ROOT_URLCONF = 'f1_foods_43597.urls'
...
WSGI_APPLICATION = 'f1_foods_43597.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "f1_foods_43597 API",
    "DESCRIPTION": "API documentation for f1_foods_43597 App",
    "VERSION": "v1",
}
